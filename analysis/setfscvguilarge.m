...
% set the figure as the current figure (handle)
% Irrespective of user interaction
...
% set figure position again (already set in plotEphys)
...
% Split current figure into subplots.
% Subplots 1, 4, 7, 10 are color plots.
% Assign color plots to hgui.hfig

% hgui.hfig{1}=subplot(5,3,1); 
% hgui.hfig{2}=subplot(5,3,4); 
% hgui.hfig{3}=subplot(5,3,7); 
% hgui.hfig{4}=subplot(5,3,10); 
for ifig=1:numcolor
    hgui.hfig{ifig}=subplot(5,3,(ifig-1)*3+1);     %1, 4, 7, 10
end

% create all other subplots
...
% Get the location and size of the component relative 
...
% Repostion color plots 
% Get new location of components
for ifig=1:numcolor
